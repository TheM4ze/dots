...
sed -i "s/ffffff/$TEXT_COLOR/g" common/gtk-3.0/3.20/assets.svg
sed -i "s/5294e2/$SELECTED_COLOR_01/g" common/gtk-3.0/3.20/assets.svg
sed -i "s/cc575d/$TEXT_COLOR/g" common/gtk-3.0/3.20/assets.svg
sed -i "s/d7787d/$SELECTED_COLOR_02/g" common/gtk-3.0/3.20/assets.svg
sed -i "s/be3841/$SELECTED_COLOR_01/g" common/gtk-3.0/3.20/assets.svg
sed -i "s/2d323d/$BASE_COLOR/g" common/gtk-3.0/3.20/assets.svg
sed -i "s/262934/$TEXT_COLOR/g" common/gtk-3.0/3.20/assets.svg
sed -i "s/2b303b/$BASE_COLOR/g" common/gtk-3.0/3.20/assets.svg
...
cp ../sass/* common/gtk-3.0/3.20/sass
